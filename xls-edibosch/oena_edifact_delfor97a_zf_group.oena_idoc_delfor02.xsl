...
#
# $Header:$
# Mapping EDIFACT DELFOR D97A -> IDOC DELFOR02 - ZF GROUP (Pleasant Praire)
...
# date      | user                              | comment
# ..............................................................................................
# 20211015  | Jorge Reis        SO/OPM74-BR     | Initial mapping - EDICUSTOMERREQUEST-5475
#
-->
...
<xsl:stylesheet version="2.0"
        ...
        <xsl:template name="G02">
                <G02>
                        ...
                        <xsl:call-template name="E2EDP15_06" />
                        <xsl:call-template name="E2EDP15_07" />
        ...
        <xsl:template name="EDI_DC">
                <EDI_DC>
                        ...
                        <EDI_DC_SNDLAD>
                                <xsl:choose>
                                      <xsl:when test="../../../UNB/UNB_S002/UNB_0007_01">
                                              <xsl:value-of select="concat(../../../UNB/UNB_S002/UNB_0007_01,'*',../../../UNB/UNB_S002/UNB_0004)" />
                                      </xsl:when>
                                      <xsl:when test="number(../../../UNB/UNB_S002/UNB_0004) and string-length(../../../UNB/UNB_S002/UNB_0004) = 9 ">
                                              <xsl:value-of select="concat('01','*',../../../UNB/UNB_S002/UNB_0004)" />
                                      </xsl:when>
                                      <xsl:otherwise>
                                              <xsl:value-of select="concat('ZZ','*',../../../UNB/UNB_S002/UNB_0004)" />
                                      </xsl:otherwise>
                              </xsl:choose>
                        </EDI_DC_SNDLAD>
                        <EDI_DC_RCVPOR>
                        ...
                        <EDI_DC_RCVLAD>
                                <xsl:choose>
                                      <xsl:when test="../../../UNB/UNB_S003/UNB_0007_02">
                                              <xsl:value-of select="concat(../../../UNB/UNB_S003/UNB_0007_02,'*',../../../UNB/UNB_S003/UNB_0010)" />
                                      </xsl:when>
                                      <xsl:when test="number(../../../UNB/UNB_S003/UNB_0010) and string-length(../../../UNB/UNB_S003/UNB_0010) = 9 ">
                                              <xsl:value-of select="concat('01','*',../../../UNB/UNB_S003/UNB_0010)" />
                                      </xsl:when>
                                      <xsl:otherwise>
                                              <xsl:value-of select="concat('ZZ','*',../../../UNB/UNB_S003/UNB_0010)" />
                                      </xsl:otherwise>
                              </xsl:choose>
                        </EDI_DC_RCVLAD>
                        <EDI_DC_CREDAT>
        ...
        <xsl:template name="E2EDKA1_WE">
                <E2EDKA1_WE>
                        ...
                        <E2EDKA1_WE_NAME1>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_C080/NAD_02_3036_01" />
                        </E2EDKA1_WE_NAME1>
                        <E2EDKA1_WE_NAME2>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_C080/NAD_02_3036_02" />
                        </E2EDKA1_WE_NAME2>
                        <E2EDKA1_WE_NAME3></E2EDKA1_WE_NAME3>
                        <E2EDKA1_WE_NAME4></E2EDKA1_WE_NAME4>
                        <E2EDKA1_WE_STRAS>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_C059/NAD_02_3042_01" />
                        </E2EDKA1_WE_STRAS>
                        <E2EDKA1_WE_STRS2>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_C059/NAD_02_3042_02" />
                        </E2EDKA1_WE_STRS2>
                        <E2EDKA1_WE_PFACH></E2EDKA1_WE_PFACH>
                        <E2EDKA1_WE_ORT01>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_3164" />
                        </E2EDKA1_WE_ORT01>
                        <E2EDKA1_WE_COUNC></E2EDKA1_WE_COUNC>
                        <E2EDKA1_WE_PSTLZ>
                                <xsl:value-of select="translate(../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_3229, '-', '')" />
                        </E2EDKA1_WE_PSTLZ>
                        <E2EDKA1_WE_PSTL2></E2EDKA1_WE_PSTL2>
                        <E2EDKA1_WE_LAND1>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_3207" />
                        </E2EDKA1_WE_LAND1>
                        ...
                        <E2EDKA1_WE_REGIO>
                                <xsl:value-of select="../SG7/NAD_02[NAD_02_3035 = 'ST']/NAD_02_3229" />
                        </E2EDKA1_WE_REGIO>
                ...
                <E2EDP10>
                        ...
                        <E2EDP10_IDNKD>
                                <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                                <xsl:message terminate="no">
                                                        <xsl:text>ERROR: no value found for IDKND (no IN or BP at LIN level). </xsl:text>
                                                </xsl:message>
                                        </xsl:otherwise>
                                </xsl:choose>
                        </E2EDP10_IDNKD>
        ...
        <xsl:template name="E2EDP15_03">
                <E2EDP15_03>
                        ...
                        <E2EDP15_03_TXT01>
                                <xsl:value-of select="'1270'" />
                        </E2EDP15_03_TXT01>
                        <E2EDP15_03_TXT02>
                                <xsl:value-of select="../../SG2[NAD_01/NAD_01_3035 = 'MI']/SG4/CTA_01[CTA_01_3139 = 'PD' or CTA_01_3139 = 'IC']/CTA_01_3139" />
                        </E2EDP15_03_TXT02>
                        <E2EDP15_03_TXT03>
                                <xsl:value-of select="'1280'" />
                        </E2EDP15_03_TXT03>
                        <E2EDP15_03_TXT04>
                                <xsl:value-of select="../../SG2[NAD_01/NAD_01_3035 = 'MI']/SG4/CTA_01[CTA_01_3139 = 'PD' or CTA_01_3139 = 'IC']/CTA_01_C056/CTA_01_3412" />
                        </E2EDP15_03_TXT04>
                        <E2EDP15_03_TXT05>
                                <xsl:value-of select="'1460'" />
                        </E2EDP15_03_TXT05>
                        <E2EDP15_03_TXT06>
                                <xsl:value-of select="concat('TE', ../../SG2[NAD_01/NAD_01_3035 = 'MI']/SG4/COM_01/COM_01_C076[COM_01_3155 = 'TE']/COM_01_3148)" />
                        </E2EDP15_03_TXT06>
                        <E2EDP15_03_TXT07>
                                <xsl:value-of select="'1450'" />
                        </E2EDP15_03_TXT07>
                        <E2EDP15_03_TXT08>
                                <xsl:value-of select="concat('FX', ../../SG2[NAD_01/NAD_01_3035 = 'MI']/SG4/COM_01/COM_01_C076[COM_01_3155 = 'FX']/COM_01_3148)" />
                        </E2EDP15_03_TXT08>
                        <E2EDP15_03_TXT09>
                                <xsl:value-of select="'1451'" />
                        </E2EDP15_03_TXT09>
                        <E2EDP15_03_TXT10>
                                <xsl:value-of select="concat('EM', ../../SG2[NAD_01/NAD_01_3035 = 'MI']/SG4/COM_01/COM_01_C076[COM_01_3155 = 'EM']/COM_01_3148)" />
                        </E2EDP15_03_TXT10>
                ...
                <E2EDP15_04>
                        ...
                        <E2EDP15_04_TXT06>
                                <xsl:choose>
                                        ...
                                        <xsl:when test="PIA/PIA_C212_01[PIA_7143_01 = 'EC']/PIA_7140_01 != ''">
                                                <xsl:value-of select="PIA/PIA_C212_01[PIA_7143_01 = 'EC']/PIA_7140_01" />
                                        </xsl:when>
                                        <xsl:when test="PIA/PIA_C212_02[PIA_7143_02 = 'EC']/PIA_7140_02 != ''">
                                                <xsl:value-of select="PIA/PIA_C212_02[PIA_7143_02 = 'EC']/PIA_7140_02" />
                                        </xsl:when>
                                        <xsl:when test="PIA/PIA_C212_03[PIA_7143_03 = 'EC']/PIA_7140_03 != ''">
                                                <xsl:value-of select="PIA/PIA_C212_03[PIA_7143_03 = 'EC']/PIA_7140_03" />
                                        </xsl:when>
                                        <xsl:when test="PIA/PIA_C212_04[PIA_7143_04 = 'EC']/PIA_7140_04 != ''">
                                                <xsl:value-of select="PIA/PIA_C212_04[PIA_7143_04 = 'EC']/PIA_7140_04" />
                                        </xsl:when>
                                        <xsl:when test="PIA/PIA_C212_05[PIA_7143_05 = 'EC']/PIA_7140_05 != ''">
                                                <xsl:value-of select="PIA/PIA_C212_05[PIA_7143_05 = 'EC']/PIA_7140_05" />
                                        </xsl:when>
                                </xsl:choose>
                        </E2EDP15_04_TXT06>
        ...
        <xsl:template name="E2EDP15_05">
                <E2EDP15_05>
                        ...
                        <E2EDP15_05_TXT01>
                                   <xsl:if test="SG20/PAC/PAC_C531/PAC_7075">
                                           <xsl:value-of select="'1190'" />
                                   </xsl:if>
                        </E2EDP15_05_TXT01>
                        <E2EDP15_05_TXT02>
                              <xsl:value-of select="SG20/PAC/PAC_C531/PAC_7075" />
                        </E2EDP15_05_TXT02>
                        <E2EDP15_05_TXT03>
                                <xsl:if test="SG20/PAC/PAC_C202/PAC_7065">
                                        <xsl:value-of select="'1020'" />
                                </xsl:if>
                        </E2EDP15_05_TXT03>
                        <E2EDP15_05_TXT04>
                                <xsl:value-of select="SG20/PAC/PAC_C202/PAC_7065" />
                        </E2EDP15_05_TXT04>
                        <E2EDP15_05_TXT05>
                                <xsl:if test="SG20/QTY_03/QTY_03_C186[QTY_03_6063 = '52']/QTY_03_6060">
                                        <xsl:value-of select="'1410'" />
                                </xsl:if>
                        </E2EDP15_05_TXT05>
                        <E2EDP15_05_TXT06>
                                <xsl:value-of select="SG20/QTY_03/QTY_03_C186[QTY_03_6063 = '52']/QTY_03_6060" />
                        </E2EDP15_05_TXT06>
        ...
        <!--Template for 'E2EDP15_06' -->
        <xsl:template name="E2EDP15_06">
                <xsl:if test="PIA/PIA_C212[PIA_7143 = 'EC']/PIA_7140 != '' or
                        PIA/PIA_C212_01[PIA_7143_01 = 'EC']/PIA_7140_01 != '' or
                        PIA/PIA_C212_02[PIA_7143_02 = 'EC']/PIA_7140_02 != '' or
                        PIA/PIA_C212_03[PIA_7143_03 = 'EC']/PIA_7140_03 != '' or
                        PIA/PIA_C212_04[PIA_7143_04 = 'EC']/PIA_7140_04 != '' or
                        PIA/PIA_C212_05[PIA_7143_05 = 'EC']/PIA_7140_05 != ''">
                        <E2EDP15_06>
                                <E2EDP15_06_SEGNAM></E2EDP15_06_SEGNAM>
                                <E2EDP15_06_MANDT></E2EDP15_06_MANDT>
                                <E2EDP15_06_DOCNUM></E2EDP15_06_DOCNUM>
                                <E2EDP15_06_SEGNUM></E2EDP15_06_SEGNUM>
                                <E2EDP15_06_PSGNUM></E2EDP15_06_PSGNUM>
                                <E2EDP15_06_HLEVEL></E2EDP15_06_HLEVEL>
                                <E2EDP15_06_TDNAME>
                                ...
                                <E2EDP15_06_TXT02></E2EDP15_06_TXT02>
                                <E2EDP15_06_TXT03></E2EDP15_06_TXT03>
                                <E2EDP15_06_TXT04></E2EDP15_06_TXT04>
                                <E2EDP15_06_TXT05></E2EDP15_06_TXT05>
                                <E2EDP15_06_TXT06></E2EDP15_06_TXT06>
                                <E2EDP15_06_TXT07></E2EDP15_06_TXT07>
                                <E2EDP15_06_TXT08></E2EDP15_06_TXT08>
                                <E2EDP15_06_TXT09></E2EDP15_06_TXT09>
                                <E2EDP15_06_TXT10></E2EDP15_06_TXT10>
                                <E2EDP15_06_TXT11></E2EDP15_06_TXT11>
                                <E2EDP15_06_TXT12></E2EDP15_06_TXT12>
                                <E2EDP15_06_TXT13></E2EDP15_06_TXT13>
                                <E2EDP15_06_TXT14></E2EDP15_06_TXT14>
                                <E2EDP15_06_TSSPRAS_ISO></E2EDP15_06_TSSPRAS_ISO>
                                <rest></rest>
                        </E2EDP15_06>
                </xsl:if>
        </xsl:template>

        <!--Template for 'E2EDP15_07' -->
        <xsl:template name="E2EDP15_07">
                <E2EDP15_07>
                        <E2EDP15_07_SEGNAM></E2EDP15_07_SEGNAM>
                        <E2EDP15_07_MANDT></E2EDP15_07_MANDT>
                        <E2EDP15_07_DOCNUM></E2EDP15_07_DOCNUM>
                        <E2EDP15_07_SEGNUM></E2EDP15_07_SEGNUM>
                        <E2EDP15_07_PSGNUM></E2EDP15_07_PSGNUM>
                        <E2EDP15_07_HLEVEL></E2EDP15_07_HLEVEL>
                        <E2EDP15_07_TDNAME>
                        ...
                        <E2EDP15_07_TXT02>
                                <xsl:value-of select="SG15/QTY_01/QTY_01_C186[QTY_01_6063 = '48']/QTY_01_6411" />
                        </E2EDP15_07_TXT02>
                        <E2EDP15_07_TXT03>
                                <xsl:if test="../SG7/NAD_02/NAD_02_3035 = 'ST'">
                                        <xsl:value-of select="'1580'" />
                                </xsl:if>
                        </E2EDP15_07_TXT03>
                        <E2EDP15_07_TXT04>
                                <xsl:for-each select="../SG7/NAD_02[NAD_02_3035 = 'ST']">
                                        <xsl:choose>
                                                <xsl:when test="NAD_02_C080/NAD_02_3036_01 !='' ">
                                                        <xsl:value-of select="concat(NAD_02_C082/NAD_02_3039,'+',
                                                                NAD_02_C080/NAD_02_3036_01,'+',
                                                                NAD_02_C059/NAD_02_3042_01,'+',
                                                                NAD_02_3164,'+',
                                                                NAD_02_3251,'+',
                                                                NAD_02_3207)" />
                                                </xsl:when>
                                                <xsl:when test="NAD_02_C080/NAD_02_3036_02 !='' ">
                                                        <xsl:value-of select="concat(NAD_02_C082/NAD_02_3039,'+',
                                                                NAD_02_C080/NAD_02_3036_02,'+',
                                                                NAD_02_C059/NAD_02_3042_02,'+',
                                                                NAD_02_3164,'+',
                                                                NAD_02_3251,'+',
                                                                NAD_02_3207)" />
                                                </xsl:when>
                                                <xsl:when test="NAD_02_C080/NAD_02_3036_03 !='' ">
                                                        <xsl:value-of select="concat(NAD_02_C082/NAD_02_3039,'+',
                                                                NAD_02_C080/NAD_02_3036_03,'+',
                                                                NAD_02_C059/NAD_02_3042_03,'+',
                                                                NAD_02_3164,'+',
                                                                NAD_02_3251,'+',
                                                                NAD_02_3207)" />
                                                </xsl:when>
                                                <xsl:when test="NAD_02_C080/NAD_02_3036_04 !='' ">
                                                        <xsl:value-of select="concat(NAD_02_C082/NAD_02_3039,'+',
                                                                NAD_02_C080/NAD_02_3036_04,'+',
                                                                NAD_02_C059/NAD_02_3042_04,'+',
                                                                NAD_02_3164,'+',
                                                                NAD_02_3251,'+',
                                                                NAD_02_3207)" />
                                                </xsl:when>
                                                <xsl:when test="NAD_02_C080/NAD_02_3036_05 !='' ">
                                                        <xsl:value-of select="concat(NAD_02_C082/NAD_02_3039,'+',
                                                                NAD_02_C080/NAD_02_3036_05,'+',
                                                                NAD_02_C059/NAD_02_3042_05,'+',
                                                                NAD_02_3164,'+',
                                                                NAD_02_3251,'+',
                                                                NAD_02_3207)" />
                                                </xsl:when>
                                                <xsl:otherwise>
                                                        <xsl:value-of select="NAD_02_C082/NAD_02_3039" />
                                                </xsl:otherwise>
                                        </xsl:choose>
                                </xsl:for-each>
                        </E2EDP15_07_TXT04>
                        <E2EDP15_07_TXT05></E2EDP15_07_TXT05>
                        <E2EDP15_07_TXT06></E2EDP15_07_TXT06>
                        <E2EDP15_07_TXT07></E2EDP15_07_TXT07>
                        <E2EDP15_07_TXT08></E2EDP15_07_TXT08>
                        <E2EDP15_07_TXT09></E2EDP15_07_TXT09>
                        <E2EDP15_07_TXT10></E2EDP15_07_TXT10>
                        <E2EDP15_07_TXT11></E2EDP15_07_TXT11>
                        <E2EDP15_07_TXT12></E2EDP15_07_TXT12>
                        <E2EDP15_07_TXT13></E2EDP15_07_TXT13>
                        <E2EDP15_07_TXT14></E2EDP15_07_TXT14>
                        <E2EDP15_07_TSSPRAS_ISO></E2EDP15_07_TSSPRAS_ISO>
                        <rest></rest>
                </E2EDP15_07>
        </xsl:template>
